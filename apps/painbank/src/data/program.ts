...
export const CHALLENGE: Challenge = {
  ...
  endDate: '2026-07-31',
  days: [
    workout('2026-07-13', 60),
    workout('2026-07-14', 65),
    workout('2026-07-15', 70),
    workout('2026-07-16', 75),
    workout('2026-07-17', 80),
    workout('2026-07-18', 85),
    rest('2026-07-19'),
    workout('2026-07-20', 90),
    workout('2026-07-21', 92),
    workout('2026-07-22', 95),
    workout('2026-07-23', 100),
    workout('2026-07-24', 105),
